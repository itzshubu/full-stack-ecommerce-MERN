  ...
  return (
    <div className="py-6 sm:py-10 bg-white dark:bg-gray-900">
      <div className="container m-auto px-4">
        <div className="text-center max-w-[600px] m-auto mb-6 sm:mb-12">
          <p className="text-sm sm:text-lg textmainColor">Top Rated Products for you</p>
          <h1 className="text-2xl sm:text-3xl font-bold my-1 sm:my-3">Best Products</h1>
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Customer-favorite styles that combine quality and elegance.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 place-items-center">
